...
fn _bind(sockfd: BorrowedFd<'_>, addr: &SocketAddr) -> io::Result<()> {
    match addr {
        SocketAddr::V4(v4) => imp::syscalls::bind_v4(sockfd, v4),
        SocketAddr::V6(v6) => imp::syscalls::bind_v6(sockfd, v6),
    }
}
...
fn _bind_any(sockfd: BorrowedFd<'_>, addr: &SocketAddrAny) -> io::Result<()> {
    match addr {
        SocketAddrAny::V4(v4) => imp::syscalls::bind_v4(sockfd, v4),
        SocketAddrAny::V6(v6) => imp::syscalls::bind_v6(sockfd, v6),
        SocketAddrAny::Unix(unix) => imp::syscalls::bind_unix(sockfd, unix),
    }
}
...
fn _connect(sockfd: BorrowedFd<'_>, addr: &SocketAddr) -> io::Result<()> {
    match addr {
        SocketAddr::V4(v4) => imp::syscalls::connect_v4(sockfd, v4),
        SocketAddr::V6(v6) => imp::syscalls::connect_v6(sockfd, v6),
    }
}
...
fn _connect_any(sockfd: BorrowedFd<'_>, addr: &SocketAddrAny) -> io::Result<()> {
    match addr {
        SocketAddrAny::V4(v4) => imp::syscalls::connect_v4(sockfd, v4),
        SocketAddrAny::V6(v6) => imp::syscalls::connect_v6(sockfd, v6),
        SocketAddrAny::Unix(unix) => imp::syscalls::connect_unix(sockfd, unix),
    }
}
